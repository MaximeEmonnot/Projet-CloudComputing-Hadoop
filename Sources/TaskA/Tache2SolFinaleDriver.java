...
public class Tache2SolFinaleDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(Tache2SolFinaleDriver.class);
        job.setJobName("Tache 2 Solution Finale");
        FileInputFormat.addInputPath(job, new Path(args[0]));
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
        job.setMapperClass(Tache2SolFinaleMapper.class);
        job.setReducerClass(Tache2SolFinaleReducer.class);
