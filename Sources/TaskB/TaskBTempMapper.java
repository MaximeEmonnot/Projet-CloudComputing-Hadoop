...
public class TaskBTempMapper extends Mapper<LongWritable, Text, Text, Text> 
{
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
    {
        ...
        if(value.getString().charAt(0).equals("U"))
        {
            ...
            //Renvoye de la nouvelle clé associée au nomUE
            context.write(new Text(newK), new Text(nomUE));
        }
        //Condition 1er caractère de la ligne commençant par N
            ...
            String newK = values[1] + "/" + values[2];
            //Renvoye de la nouvelle clé associée à une chaine de caractère indiquant la réussite ou non 
